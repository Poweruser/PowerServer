...
public class GamespyValidation {
    ...
    public boolean verifyChallengeResponse(GameBase game, EncType type, String response) {
        this.gamekey = game.getGamespyKey().getBytes();
        this.type = type;
        String correctValidate = this.getValidationString();
    ...
    public static String createChallengeString() {
        ...
        for(int i = 0; i < 6; i++) {
            do {
                rnd = ((rnd * 0x343FDL) + 0x269EC3L) & 0x7FL;
    ...
    public String getChallengeString() {
        return new String(this.securekey);
    }
}
